...
def config_load(tui):
    ...
    if tui == 'asciimatics':
        ...
        return [
        (['bg']+[config['pallette']['background'].split(',')[0], config['pallette']['background'].split(',')[2], '' if config['pallette']['background'].split(',')[1] == 'normal' else config['pallette']['background'].split(',')[1]]),
